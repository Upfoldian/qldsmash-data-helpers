...
xml = Nokogiri::XML(File.read "SSBM.xml")
...
regionCharData = JSON.parse(File.read('melee-end.json'))
...
File.open("formattedSSBM.json", 'w') { |file| file.write(JSON.pretty_generate(newFormatHash))}
puts "Finished!"
